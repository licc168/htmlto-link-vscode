...
exports.getDeploymentMetadata = getDeploymentMetadata;
...
async function saveDeploymentMetadata(folderPath, metadata) {
    const filePath = getMetadataFilePath(folderPath);
    await fs.writeFile(filePath, JSON.stringify(metadata, null, 2), 'utf8');
}
async function setLastDeployedUrl(context, url) {
